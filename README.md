...
Выпускник ВСГУТУ по программной инженерии. Пришёл в QA осознанно —
нравится находить то, что разработчики пропустили, и докапываться до
корневой причины бага. Сейчас строю портфолио и ищу первую коммерческую позицию.
...
- 📖 ISTQB Foundation — методологии и техники тест-дизайна
- 🤖 Python + Playwright — автоматизация UI-тестов
- 🔌 REST API тестирование — Postman, статус-коды, JSON-схемы
- 🗄 SQL — верификация данных на стыке фронта и БД
...
*Дотошный до занудства — для тестировщика это профессиональный плюс, а не баг характера.*
